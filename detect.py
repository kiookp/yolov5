...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default=ROOT / 'my/img', help='file/dir/URL/glob/screen/0(webcam)')
    parser.add_argument('--data', type=str, default=ROOT / 'data/data.yamll', help='(optional) dataset.yaml path')
